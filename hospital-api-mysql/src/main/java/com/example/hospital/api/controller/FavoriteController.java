...
import com.example.hospital.api.controller.form.SearchFavoriteByPageForm;
...
public class FavoriteController {
    ...
    @SaCheckLogin
    public R searchByPage(@RequestBody @Valid SearchFavoriteByPageForm form) {
        ...
        boolean canManageAll = isRoot || (permissions.contains("FAVORITE:SELECT") && refId == null);
        ...
        PageUtils pageUtils = favoriteService.searchByPage(param);
