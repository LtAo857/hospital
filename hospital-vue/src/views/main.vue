		...
		<aside class="site-sidebar site-sidebar--dark">
			<div class="site-sidebar__inner">
				...
				>
					...
					<el-sub-menu index="疾病管理" :popper-class="'site-sidebar--' + sidebarLayoutSkin + '-popper'">
						<template #title>
							<SvgIcon name="night_fill" class="icon-svg" />
						...
						<el-menu-item
							index="疾病百科"
							@click="$router.push({ name: 'Illness' })"
					
						>
	
							<SvgIcon name="camera_fill" class="icon-svg" />
							<span slot="title">疾病百科</span>
						</el-menu-item>
					</el-sub-menu>
