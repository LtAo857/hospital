<template>
    <div v-if="isAuth(['ROOT', 'DOCTOR:SELECT'])">
      ...
      <el-table-column show-overflow-tooltip="true"  prop="master_id" header-align="center" align="center" min-width="70" height="50px" label="主人"  />
      <el-table-column show-overflow-tooltip="true"  prop="sex" header-align="center" align="center" min-width="70" height="50px" label="公母"  />
      <el-table-column show-overflow-tooltip="true"  prop="hobby" header-align="center" align="center" min-width="70" height="50px" label="爱好"  />
            <el-table-column show-overflow-tooltip="true"  prop="birthday" header-align="center" align="center" min-width="70" height="50px" label="生日"  />
            <el-table-column show-overflow-tooltip="true" prop="disease_history" header-align="center" align="center" min-width="120" label="疾病史" />
            <el-table-column show-overflow-tooltip="true" prop="breed" header-align="center" align="center" min-width="100" label="品种" />
            <el-table-column show-overflow-tooltip="true" prop="weight" header-align="center" align="center" min-width="100" label="体重" />
            <el-table-column show-overflow-tooltip="true" prop="image" header-align="center" align="center" min-width="100" label="照片" />
            <el-table-column show-overflow-tooltip="true" prop="vaccine" header-align="center" align="center" min-width="100" label="疫苗接种情况" />
...
<script>
import AddOrUpdate from './pet-add-or-update.vue';
export default {
    components: {
        AddOrUpdate
    },
    ...
    //     that.$http('/pet/searchByPageAndId', 'POST', data, true, function(resp) {
      ...
      deleteHandle: function(id) {
          ...
          if (ids.length == 0) {
              ...
              that.$confirm('确定要删除选中的记录？', '提示', {
                  ...
                  that.$http('/pet/deleteByIds', 'POST', { ids: ids }, true, function(resp) {
                      ElMessage({
                          message: '操作成功',
                          type: 'success',
                          duration: 1200,
