...
INSERT INTO `mis_role_permission` VALUES (0,0,0),(1,1,4),(2,1,16),(3,1,20),(4,1,24),(5,1,28),(6,1,32),(7,2,36),(8,2,37),(9,0,56),(10,1,56);
...
--
-- Table structure for table `video_diagnose`
--
...
CREATE TABLE `video_diagnose` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `video_diagnose_idx_1` (`patient_card_id`) USING BTREE,
  KEY `video_diagnose_idx_2` (`doctor_id`) USING BTREE,
  KEY `video_diagnose_idx_3` (`out_trade_no`) USING BTREE,
  KEY `video_diagnose_idx_4` (`payment_status`) USING BTREE,
  KEY `video_diagnose_idx_5` (`prepay_id`) USING BTREE,
  KEY `video_diagnose_idx_6` (`transaction_id`) USING BTREE,
  KEY `video_diagnose_idx_7` (`expect_start`) USING BTREE,
  KEY `video_diagnose_idx_8` (`expect_end`) USING BTREE,
  KEY `video_diagnose_idx_9` (`status`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `video_diagnose_file`
--
...
CREATE TABLE `video_diagnose_file` (
  `id` int NOT NULL AUTO_INCREMENT,
  `video_diagnose_id` int DEFAULT NULL,
  ...
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `video_diagnose_file_idx_1` (`video_diagnose_id`) USING BTREE,
  KEY `video_diagnose_file_idx_2` (`create_time`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
